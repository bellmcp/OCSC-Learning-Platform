...
export default function CurriculumCertificateView() {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `ประกาศนียบัตรหลักสูตร${currentCertificate?.curriculum}-${currentCertificate?.firstname} ${currentCertificate?.lastname}`,
        ...
        <>
          ...
          <Box my={6} style={{ overflow: 'auto' }}>
            <CertificateRenderer
              ...
              position2={position2}
              coSigner={coSigner}
              coSignatureUrl={coSignatureUrl}
              coPosition1={coPosition1}
              coPosition2={coPosition2}
            />
          </Box>
          <Box my={3}>
            <Button
